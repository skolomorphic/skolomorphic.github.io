...
// 1FAIpQLSc8QeiD2bHTcLlRPSvlsMep-dorfdUE_WjHx9uYX9VFCbKXdA
// /viewform?usp=pp_url
// &entry.2037385180=Name
// &entry.697624275=Website
// &entry.1441219692=Text
// &entry.1784440792=Page
// &entry.980636386=Reply
// https://docs.google.com/spreadsheets/d/1ilu21Sz6bPvk9ozOfAecE9D34lXxPGjQapoF5vXz91Y/edit?resourcekey&gid=1081015777#gid=1081015777 <=sheet 1 
// https://docs.google.com/spreadsheets/d/1ilu21Sz6bPvk9ozOfAecE9D34lXxPGjQapoF5vXz91Y/edit?resourcekey&gid=1144937638#gid=1144937638 <- sheet2 
// The values in this section are REQUIRED for the widget to work! Keep them in quotes!
const s_stylePath = '/comment-widget.css';
const s_formId = '1FAIpQLSc8QeiD2bHTcLlRPSvlsMep-dorfdUE_WjHx9uYX9VFCbKXdA';
const s_nameId = '2037385180';
const s_websiteId = '697624275';
const s_textId = '1441219692';
const s_pageId = '1784440792';
const s_replyId = '980636386';
const s_sheetId = '1ilu21Sz6bPvk9ozOfAecE9D34lXxPGjQapoF5vXz91Y';
const s_sheet_whichSheet_Id = 'Sheet2';
...
const s_maxLengthName = 80; // The max character length of a name
...
function getComments() {
    ...
    // Get the data
    const url = `https://docs.google.com/spreadsheets/d/${s_sheetId}/gviz/tq?sheet=${s_sheet_whichSheet_Id}`;
    ...
    retrievedSheet.then(result => {
        ...
        if (json.table.parsedNumHeaders > 0) { // Check if any comments exist in the sheet at all before continuing
            for (let r = 0; r < json.table.rows.length; r++) {
                ...
                if (val1 == v_pagePath || val1 + "/" == v_pagePath) { 
                    let comment = {}
